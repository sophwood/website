  ...
  create: function (context) {
    ...
    function checkForShadows (scope) {
      ...
      for (var i = 0; i < variables.length; ++i) {
        ...
        if (shadowed &&
          (shadowed.identifiers.length > 0 || (options.builtinGlobals && "writeable" in shadowed)) && !isOnInitializer(variable, shadowed) && !(options.hoist !== "all" && isInTdz(variable, shadowed))
        ) {
          context.report({
